...
class EventExporter:
    ...
    def __init__(self, batch_id: str = None):
        ...
        self.export_dir = os.path.join(EXPORTS_DIR, self.batch_id)
    ...
    def _format_timestamp(self, ts_str: str) -> str:
        ...
        # 如果都失败，原样返回并添加时区
        return ts_str if ts_str.endswith('+08:00') else f"{ts_str}+08:00"
    ...
    def write_manifest(self, record_count: int) -> Dict:
        ...
        manifest = {
            ...
            "schema": {
                ...
                "optional_fields": ["content", "category", "tickers", "sentiment"],
            },
...
def list_exports(limit: int = 10) -> List[Dict]:
    ...
    for name in sorted(os.listdir(EXPORTS_DIR), reverse=True):
        batch_dir = os.path.join(EXPORTS_DIR, name)
        if os.path.isdir(batch_dir):
            ...
            if os.path.exists(manifest_file):
                with open(manifest_file, 'r', encoding='utf-8') as f:
                    ...
                    batch_info["created_at"] = manifest.get("created_at", "")
